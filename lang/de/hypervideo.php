...
/**
 * German language strings for mod_hypervideo.
 *
...
$string['currentTime'] = 'Aktuelle Position';
$string['duration'] = 'Dauer';
$string['exit_fullscreen'] = 'Vollbild beenden';
$string['fullscreen'] = 'Vollbild';
$string['mute'] = 'Stummschalten';
$string['next_chapter'] = 'Nächstes Kapitel';
$string['next_video'] = 'Nächstes Video';
$string['pause'] = 'Pause';
$string['play'] = 'Abspielen';
$string['playback_speed'] = 'Wiedergabegeschwindigkeit';
$string['player_loading'] = 'Video wird geladen...';
$string['previous_chapter'] = 'Vorheriges Kapitel';
$string['previous_video'] = 'Vorheriges Video';
$string['rewatch'] = 'Erneut ansehen';
$string['show_sidebar'] = 'Seitenleiste anzeigen';
$string['hide_sidebar'] = 'Seitenleiste ausblenden';
$string['survey_question'] = 'Ich fand das Video gut strukturiert';
$string['survey_label_1'] = 'Stimme überhaupt nicht zu';
$string['survey_label_2'] = 'Stimme nicht zu';
$string['survey_label_3'] = 'Neutral';
$string['survey_label_4'] = 'Stimme zu';
$string['survey_label_5'] = 'Stimme voll und ganz zu';
$string['survey_submit'] = 'Feedback absenden';
$string['unmute'] = 'Ton einschalten';
...
$string['playerstyle'] = 'Player-Stil';
$string['playerstyle_plain'] = 'Einfach';
$string['playerstyle_chapters'] = 'Kapitel';
$string['playerstyle_playlist'] = 'Playlist';
$string['playerstyle_random'] = 'Zufällig';
