...
$string['next_video'] = 'Next video';
$string['pause'] = 'Pause';
$string['play'] = 'Play';
$string['playback_speed'] = 'Playback speed';
...
$string['previous_video'] = 'Previous video';
$string['rewatch'] = 'Replay';
$string['show_sidebar'] = 'Show sidebar';
$string['hide_sidebar'] = 'Hide sidebar';
$string['survey_question'] = 'I found the video to be well structured';
$string['survey_label_1'] = 'Strongly disagree';
$string['survey_label_2'] = 'Disagree';
$string['survey_label_3'] = 'Neutral';
$string['survey_label_4'] = 'Agree';
...
$string['playerstyle'] = 'Player style';
$string['playerstyle_plain'] = 'Plain';
$string['playerstyle_chapters'] = 'Chapters';
$string['playerstyle_playlist'] = 'Playlist';
$string['playerstyle_random'] = 'Random';
